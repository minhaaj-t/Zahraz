...
async function insertDummyData() {
  try {
    ...
    const bannerCount = bannerRows[0]?.count || 0;
    if (bannerCount === 0) {
      await pool.query(`
        INSERT INTO banners (title, subtitle, image, buttonText, buttonLink, orderIndex, isActive) VALUES
        ('New Collection 2024', 'Discover the latest trends and premium products', 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=1200&q=80', 'Shop Now', '/products', 0, TRUE),
        ('Special Offer', 'Up to 50% off on selected items', 'https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=1200&q=80', 'Explore Deals', '/offers', 1, TRUE),
        ('Premium Quality', 'Experience luxury with our curated selection', 'https://images.unsplash.com/photo-1445205170230-053b83016050?w=1200&q=80', 'View Collection', '/products', 2, TRUE)
      `);
    }
